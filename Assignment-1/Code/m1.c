...
{ 
 ...
 float adcvalue;
	...
	while (1)
  {
    ...
    sprintf(ledoutput, "Brightness level=%.0f%   ", (brightness/255)*100);
...
while(1)

  {
    ...
    PWMMR1 = 255-dutycycle;                 //set dutycycle value to PWM match register 
    ...
    sprintf(ledoutput, "PWM OP=%.2f   ", extra);  
